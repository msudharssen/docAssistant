function Chatbox({info, info2}) {
  return (
    <div className="fixed left-1/4 bottom-1/4 w-3/4 h-3/4 bg-white/95 backdrop-blur-md rounded-xl shadow-2xl border border-white/20 flex items-center justify-center">
